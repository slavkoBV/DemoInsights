...
def test_get_insights_success(client, create_bucket, mocker):
    mock_file_data = json.dumps(
        {"results": {"transcripts": [{"transcript": "Lorem ipsum dolor sit amet, consectetur adipiscing elit."
    ...
    response = client.post(
        "/insights",
        json={"interaction_url": "http://test_url1", "trackers": ["Lorem ipsum", "et est nec"]},
    )
